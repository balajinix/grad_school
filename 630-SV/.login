...
if ( -f /usr/bin/uname ) then
  ...
  if ( "$OSrelease" == "5" ) then       # OS is System V - Solaris
    set path=( /bin /usr/ccs/bin /opt/SUNWspro/bin /usr/sbin /opt/cygnus/bin /usr/ccs/bin /usr/local/bin/ /usr/etc  /etc  /usr/openwin/bin /usr/X11/bin /usr/bin /opt/unsupported/bin /opt/SUNWmotif/bin /usr/ucb . )
...
#    Set terminal characteristic
   ...
   set path=(  /etc /usr/etc /usr/hosts /usr/ucb /usr/bin /bin ~/bin /usr/local /usr/local/bin /usr/openwin/bin /usr/bin/X11 . )
#   Set terminal characteristic
